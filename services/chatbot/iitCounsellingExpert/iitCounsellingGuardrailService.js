...
const ICE_EMPTY_FALLBACK =
  'I could not prepare an IIT counselling answer just now. Please reply AGENT to speak with our team, or MENU for more options.';

const UNKNOWN_FALLBACK =
  "I don't currently have verified information on that topic. Please contact the GuideXpert counselling team for accurate guidance.";
...
function validateIitCounsellingResponse({
  response,
  knowledgeResults = [],
  userMessage = '',
  englishUserMessage = '',
  ...
  if (!text) {
    return { text: ICE_EMPTY_FALLBACK, modified: true, reason: 'empty_response' };
  }
