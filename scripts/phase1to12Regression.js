...
/**
 * Phase 1–12 local regression runner.
 * Run: node scripts/phase1to12Regression.js
 */
...
const STEPS = [
  { name: 'journey_1_12', cmd: 'node', args: ['--test', 'test/careerCounsellingJourney.test.js'] },
...
function main() {
  ...
  const summary = {
    suite: 'phase_1_to_12_regression',
