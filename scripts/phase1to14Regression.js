...
/**
 * Phase 1–14 local regression runner.
 * Run: node scripts/phase1to14Regression.js
 */
...
const STEPS = [
  { name: 'journey_1_14', cmd: 'node', args: ['--test', 'test/careerCounsellingJourney.test.js'] },
  ...
  { name: 'phase14_cert', cmd: 'node', args: ['scripts/phase14ProductionCertification.js'] },
];
...
function main() {
  ...
  const summary = {
    suite: 'phase_1_to_14_regression',
